...
Note that there is [[https://github.com/meliache/geohashing.el][another Emacs Lisp implementation]] that I discovered
/after/ creating =v0.1.0=. It could be interesting to compare the two!
